...
export function CartLargeDuotone({ className }: Props) {
  return (
    <svg
      className={className}
      ...
      viewBox="0 0 24 24"
    >
      <title>cart-large-duotone</title>
      <g fill="currentColor">
        <path
          fillRule="evenodd"
        ...
        <path
          ...
          opacity=".5"
        />
        <path d="M7.25 9A.75.75 0 0 1 8 8.25h3a.75.75 0 0 1 0 1.5H8A.75.75 0 0 1 7.25 9m.25 9a1.5 1.5 0 1 1 0 3a1.5 1.5 0 0 1 0-3M18 19.5a1.5 1.5 0 1 0-3 0a1.5 1.5 0 0 0 3 0" />
      </g>
    </svg>
  );
}

export default CartLargeDuotone;

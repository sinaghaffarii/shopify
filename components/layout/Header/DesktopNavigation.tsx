...
const DesktopNavigation = () => {
  return (
    <div className="w-[95%] max-w-325 mx-auto mt-3 space-y-3">
      {/* هدر اصلی */}
      <div className="bg-white rounded shadow-[0_2px_10px_rgba(0,0,0,0.08)] px-5 py-3 flex items-center justify-between">
        ...
        <div className="flex-1 max-w-md mx-6 relative">
          <input
            ...
            className="w-full bg-gray-50/80 border border-gray-200/80 rounded py-2.5 px-5 pr-12 text-sm focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all placeholder:text-gray-400"
          />
          <Search
      ...
      {/* نوار منو */}
      <div className="bg-white rounded shadow-[0_1px_6px_rgba(0,0,0,0.08)] px-6 py-3 flex items-center gap-8 text-sm text-gray-700 overflow-x-auto">
        <a
          href="#"

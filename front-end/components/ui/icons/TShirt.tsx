...
export function TShirt({ className }: Props) {
  return (
    <svg
      className={className}
    ...
    >
      ...
      <g fill="currentColor">
        <path
          d="m4.832 10.426l-1.166.582a.5.5 0 0 1-.712-.338l-.942-4.238a.5.5 0 0 1 .135-.463l2.246-2.24A2.5 2.5 0 0 1 6.158 3h2.007a.5.5 0 0 1 .493.415c.286 1.658 1.039 2.409 2.34 2.409s2.055-.751 2.342-2.41A.5.5 0 0 1 13.833 3h2.007a2.5 2.5 0 0 1 1.765.73l2.248 2.24a.5.5 0 0 1 .135.462l-.944 4.236a.5.5 0 0 1-.712.338l-1.166-.58V17.5a2.5 2.5 0 0 1-2.5 2.5H7.332a2.5 2.5 0 0 1-2.5-2.5z"
          opacity=".2"
        />
        <path
          fill-rule="evenodd"
